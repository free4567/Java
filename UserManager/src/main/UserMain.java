				...
				while(true) {
						...
						if(answer == 0) {
								break;
									...
									UserDao.getlnstance().insertUser(user);
									System.out.println("입력완료...");
						}else if(answer == 2) {
									// 데이터 조회
									List<User> users = UserDao.getlnstance().selectUsers();
								...
								User user = UserDao.getlnstance().selectUser(name);
								...
								int result = UserDao.getlnstance().deleteUser(uid);
